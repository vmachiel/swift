...
class SelectionScreen: UIViewController {
    ...
    // This is actually an instance of the "intern". Give it some orders.
    ...
    @IBAction func rebelButtonTapped(_ sender: UIButton) {
        selectionDelegate.didTapChoice(image: UIImage(named: "vader")!, name: "Darth Vader", color: .white)
        dismiss(animated: true, completion: nil)
    }
    
    @IBAction func imperialButtonTapped(_ sender: UIButton) {
        selectionDelegate.didTapChoice(image: UIImage(named: "luke")!, name: "Luke Skywalker", color: .red)
        dismiss(animated: true, completion: nil)
    }
