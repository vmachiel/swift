...
// Break in a switch statement. Example: do nothing in the default case.
...
// Guard statements can be used to early exit. If the assignment after guard can't
// be done, the else block is executed.
